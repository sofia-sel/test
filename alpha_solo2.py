...
def generate():
    ...
    while True:
        ...
        # Extract the temperature data from the thermal frame
        ...
        temperature_data = ndimage.zoom(temperature_data, 20)  # Upscale to match image size

        # Create a mask where temperatures below 40°C are marked as transparent
        mask = (temperature_data >= 40).astype(np.uint8)
